...
export function SidebarContent() {
  ...
  const socialLinks = [
    ...
    {
      name: "Join Telegram",
      icon: <MessageCircle className="w-5 h-5 mr-2 text-[#06a57f]" />,
      url: "https://web.telegram.org/k/#@autopilotx_in",
    },
    {
      name: "Follow on Instagram",
      icon: <Instagram className="w-5 h-5 mr-2 text-[#06a57f]" />,
      url: "https://www.instagram.com/autopilotx.in/",
    },
  ];
            ...
            onClick={(e) => {
              if (item.name === "History") {
                ...
                if (brokerName === "coindcx") {
                  window.open("https://coindcx.com/stats/futures/orders", "_blank");
                  return;
                }
              }
